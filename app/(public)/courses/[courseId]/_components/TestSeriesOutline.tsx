...
import { usePublicTestSeriesOutlineQuery } from "../_queries/courseDetail.queries";
...
export function TestSeriesOutline({ testSeriesId, testSeriesTitle, testSeriesPrice }: TestSeriesOutlineProps) {
    ...
    <div className="space-y-6">
      ...
      {testSeriesId ? (
        ...
        <div className="py-12 flex flex-col items-center justify-center text-center text-slate-400">
          <AlertCircle className="h-10 w-10 text-slate-350 mb-2" />
          <p className="text-xs font-semibold">No test series linked with this batch.</p>
        </div>
      )}
    </div>
  );
