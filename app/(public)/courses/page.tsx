        ...
        <main className="flex-1 p-6 md:p-8 lg:p-10 space-y-6 w-full">
          ...
          <div className="select-none mb-3">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Get the only NCET preparation course taught by actual IITians.
            </p>
          </div>
          ...
          {processedCourses.length === 0 ? (
            <div className="w-full py-16 flex flex-col items-center justify-center text-center">
              ...
              <h3 className="text-lg font-extrabold text-slate-950 dark:text-slate-50 mb-1">No Batches Found</h3>
              <p className="text-xs text-slate-400 max-w-sm leading-relaxed mb-6">
                No active or upcoming batches match your criteria. Try adjusting your query or resetting filters.
              </p>
